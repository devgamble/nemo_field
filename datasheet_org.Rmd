...
nemo_allFs_AC <- read_csv(here::here("data_sheets", "compiled_sheets", "AC_mastersheet_v2_allFitness-only_2022-08-18.csv"))

nemo_allFs_BB <- read_csv(here::here("data_sheets", "compiled_sheets", "BB_mastersheet_v2_allFitness-only_2022-08-18.csv"))

nemo_allFs_BO <- read_csv(here::here("data_sheets", "compiled_sheets", "BO_mastersheet_v2_all-Fitness-only_2022-08-18.csv"))

nemo_allFs_HR <- read_csv(here::here("data_sheets", "compiled_sheets", "HR_mastersheet_v2_all-Fitness-only_2022-08-18.csv"))
...
```{r}
AC_weights <- read_csv(here::here("data_sheets", "skeleton_and_stem_data", "skeleton_weights_AC.csv")) %>% select(-Units) %>% 
...
#rows without any notes might be incomplete and still able to be pulverized
...
pulv_sheet2 <- pulv_sheet1 %>% 
  mutate(`Amount (mg)` = NA, `Tray Name` = NA, `Well ID` = NA, `Type of Material` = "plant stem tissue", Analysis = "13C, 15N", Enriched = "No") %>% 
  select(Transect, Recipient, Plant_ID, `Sample ID`, `Amount (mg)`, `Tray Name`, `Well ID` = seq(from = A1, to = H16), `Type of Material`, Analysis, Enriched)
