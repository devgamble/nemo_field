...
BO_fruitprod_1 <- read_csv(here::here("data_sheets", "fruit_seed_counts_final", "BO-fruit-production_2023-02-05.csv"), skip = 1) %>% 
...
BO_seedct_1 <- read_csv(here::here("data_sheets", "fruit_seed_counts_final", "BO-seed-count_2023-02-05.csv"), skip = 1) %>% 
  select(-c(1, 3, 7:33)) %>% 
...
write_csv(BO_mastersheet_v1, here::here("data_sheets", "compiled_sheets", "BO_mastersheet_full_2023-02-06.csv"))
...
write_csv(BO_mastersheet_F_mains, here::here("data_sheets", "compiled_sheets", "BO_mastersheet_Fitness-mains_2023-02-06.csv"))

write_csv(BO_mastersheet_F_all, here::here("data_sheets", "compiled_sheets", "BO_mastersheet_Fitness-all_2023-02-06.csv"))
