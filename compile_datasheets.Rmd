...
NOTE: All date data should be standardized prior to importing into R. In Excel, set format to YYYY-MM-DD for consistency. Unfortunately, this process in Excel will autopopulate the year (when not already present) based on system settings. For germination data, this means that the year should be corrected to 2021!!
