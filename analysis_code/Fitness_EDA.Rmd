...
## AC
AC_mainF_Y1 <- read_csv(here::here("data_sheets", "compiled_sheets", "AC_mastersheet_Fitness-mains_2023-08-07.csv")) 

## BB
BB_mainF_Y1 <- read_csv(here::here("data_sheets", "compiled_sheets", "BB_mastersheet_Fitness-mains_2023-08-07.csv"))
## Already has greenhouse cohort data

## BO
BO_mainF_Y1 <- read_csv(here::here("data_sheets", "compiled_sheets", "BO_mastersheet_Fitness-mains_2023-08-07.csv")) 

## HR
HR_mainF_Y1 <- read_csv(here::here("data_sheets", "compiled_sheets", "HR_mastersheet_Fitness-mains_2023-08-07.csv"))
...
AC_prop1 <- AC_mainF_Y1 %>% 
  filter(closed_fruits_F == 0) %>% 
  summarize(zero_closed = n()) #23

#Proportion of Fitness plants with 0 total fruits
AC_prop2 <- AC_mainF_Y1 %>% 
  filter(total_fruits_F == 0) %>% 
  summarize(zero_closed = 23/319,
            zero_total = n()/319) #11

#Good estimates of fecundity - including 0s
AC_prop2b <- AC_mainF_Y1 %>% 
...
Proportion of individuals with reproductive fitness = 0? 
- Note: 0s in seed count need to be corrected to NA when closed_fruit = 0

```{r}
##AC##

#Closed Fruit
nrow(filter(Fitness_AC_df3.5, closed_fruits == 0))/nrow(Fitness_AC_df3.5)

#Relative estimated seed production
#nrow(filter(Fitness_AC_df3.5, Rel_est_seed_prod == 0))/nrow(Fitness_AC_df3.5)


##BB##  

nrow(filter(Fitness_BB_df3.5, closed_fruits == 0))/nrow(Fitness_BB_df3.5)



##BO##  

nrow(filter(Fitness_BO_df3.5, closed_fruits == 0))/nrow(Fitness_BO_df3.5)


##HR##  

nrow(filter(Fitness_HR_df3.5, closed_fruits == 0))/nrow(Fitness_HR_df3.5)
...
```{r}
FITBB_no_0s <- filter(Fitness_BB_df3.5, closed_fruits > 0) %>% group_by(Donor, Recipient) %>% 
  summarize(
    MATmean_est_seed_prod = mean(est_seed_prod, na.rm = TRUE),
    MATmean_seed_count = mean(seed_count, na.rm = TRUE),
    MATmean_P_surv_flower = mean(P_surv_flower, na.rm = TRUE), #Relative measures of fitness
...
ggplot() +
  geom_density(data = Fitness_BB_df4, aes(x = Rel_MATmean_total_fruit_prod), fill = "#A58AFF", color = "black", alpha = 0.3) + 
  geom_density(data = FITBB_no_0s, aes(x = Rel_MATmean_total_fruit_prod), fill = "orange", color = "black", alpha = 0.3) +
  theme_classic() +
...
ggplot() +
  geom_histogram(data = Fitness_BB_df4, aes(x = Rel_MATmean_total_fruit_prod), fill = "#A58AFF", color = "black", alpha = 0.3) + 
  geom_histogram(data = FITBB_no_0s, aes(x = Rel_MATmean_total_fruit_prod), fill = "orange", color = "black", alpha = 0.3) +
  theme_classic() +
  scale_y_continuous(expand = c(0,0)) +
  ylab("Count") +
  xlab("Avg. Maternal Total Fruit Production (N=107) (Relative)")
...
```{r}
FITBO_no_0s <- filter(Fitness_BO_df3.5, closed_fruits > 0) %>% group_by(Donor, Recipient) %>% 
  summarize(
    MATmean_est_seed_prod = mean(est_seed_prod, na.rm = TRUE),
    MATmean_seed_count = mean(seed_count, na.rm = TRUE),
    MATmean_P_surv_flower = mean(P_surv_flower, na.rm = TRUE), #Relative measures of fitness
...
ggplot() +
  geom_density(data = Fitness_BO_df4, aes(x = Rel_MATmean_total_fruit_prod), fill = "#A58AFF", color = "black", alpha = 0.3) + 
  geom_density(data = FITBO_no_0s, aes(x = Rel_MATmean_total_fruit_prod), fill = "orange", color = "black", alpha = 0.3) +
  theme_classic() +
  scale_y_continuous(expand = c(0,0)) +
  ylab("Count") +
  xlab("Avg. Maternal Total Fruit Production (N=107) (Relative)")
...
ggplot() +
  geom_histogram(data = Fitness_BO_df4, aes(x = Rel_MATmean_total_fruit_prod), fill = "#A58AFF", color = "black", alpha = 0.3) + 
  geom_histogram(data = FITBO_no_0s, aes(x = Rel_MATmean_total_fruit_prod), fill = "orange", color = "black", alpha = 0.3) +
  theme_classic() +
  scale_y_continuous(expand = c(0,0)) +
  ylab("Count") +
  xlab("Avg. Maternal Total Fruit Production (N=107) (Relative)")
...
```{r}
FITHR_no_0s <- filter(Fitness_HR_df3.5, closed_fruits > 0) %>% group_by(Donor, Recipient) %>% 
  summarize(
    MATmean_est_seed_prod = mean(est_seed_prod, na.rm = TRUE),
    MATmean_seed_count = mean(seed_count, na.rm = TRUE),
    MATmean_P_surv_flower = mean(P_surv_flower, na.rm = TRUE), #Relative measures of fitness
...
ggplot() +
  geom_density(data = Fitness_HR_df4, aes(x = Rel_MATmean_total_fruit_prod), fill = "#A58AFF", color = "black", alpha = 0.3) + 
  geom_density(data = FITHR_no_0s, aes(x = Rel_MATmean_total_fruit_prod), fill = "orange", color = "black", alpha = 0.3) +
  theme_classic() +
  scale_y_continuous(expand = c(0,0)) +
  ylab("Count") +
  xlab("Avg. Maternal Total Fruit Production (N=107) (Relative)")
...
ggplot() +
  geom_histogram(data = Fitness_HR_df4, aes(x = Rel_MATmean_total_fruit_prod), fill = "#A58AFF", color = "black", alpha = 0.3) + 
  geom_histogram(data = FITHR_no_0s, aes(x = Rel_MATmean_total_fruit_prod), fill = "orange", color = "black", alpha = 0.3) +
  theme_classic() +
  scale_y_continuous(expand = c(0,0)) +
  ylab("Count") +
  xlab("Avg. Maternal Total Fruit Production (N=107) (Relative)")
