...
### ADD IN Cohort to each of the master data sheets
...
- ?? Survival x Total Fruit Production?? (Probably not) 
...
```{r message = FALSE}
## AC
AC_master_df1 <- read_csv(here::here("data_sheets", "compiled_sheets", "AC_mastersheet_v1_2022-07-26.csv")) #Parsing issue with 6-22 flowering date

## BB
BB_master_df1 <- read_csv(here::here("data_sheets", "compiled_sheets", "BB_mastersheet_v1_2022-08-02.csv"))
#No watered points present


## BO
BO_master_df1 <- read_csv(here::here("data_sheets", "compiled_sheets", "BO_mastersheet_v1_2022-08-02.csv")) #Parsing issue with Fl_3.11 flowering date
