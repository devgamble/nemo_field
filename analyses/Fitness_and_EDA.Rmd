...
## AC
AC_master_df <- read_csv(here::here("data_sheets", "compiled_sheets", "AC_mastersheet_v1_2022-07-26.csv")) #Parsing issue with 6-22 flowering date
...
## BO
BO_master_df <- read_csv(here::here("data_sheets", "compiled_sheets", "BO_mastersheet_v1_2022-08-02.csv")) #Parsing issue with Fl_3.11 flowering date
BO_master_df1 <- left_join(BO_master_df, BO_tray21, by = c("Donor", "Recipient")) %>% 
  rename(Co. = Cohort)


## HR
HR_master_df <- read_csv(here::here("data_sheets", "compiled_sheets", "HR_mastersheet_v1_2022-08-16.csv"))
